...
fn main() -> Result<(), Error> {
    ...
    match day {
        ...
        21 => {
            let day_21 = input::read_lines("input/day_21")?;
            println! {"day_21_1: {}", day_21::day_21_1(&day_21)}
            println! {"day_21_2: {}", day_21::day_21_2(&day_21,)}
        }
        22 => {
            let day_22 = input::read_lines("input/day_22")?;
            println! {"day_22_1: {}", day_22::day_22_1(&day_22)}
            println! {"day_22_2: {}", day_22::day_22_2(&day_22,)}
        }
        23 => {
            let day_23 = input::read_one_line("input/day_23");
            println! {"day_23_1: {}", day_23::day_23_1(&day_23)}
            println! {"day_23_2: {}", day_23::day_23_2(&day_23,)}
        }
        24 => {
            let day_24 = input::read_lines("input/day_24")?;
            println! {"day_24_1: {}", day_24::day_24_1(&day_24)}
            println! {"day_24_2: {}", day_24::day_24_2(&day_24,)}
        }
        25 => {
            println! {"day_25_1: {}", day_25::day_25(&input::read_lines("input/day_25")?)}
        }
        _ => {}
    }
